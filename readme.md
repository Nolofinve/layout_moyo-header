# Moyo header
Create an HTML page with the header using `flexbox` based on the [Figma Mockup](https://www.figma.com/design/1sog2rmfyCjnVxkeZ3ptnc/MOYO---Header?node-id=2-15&m=dev).
...
- [DEMO LINK](https://Nolofinve.github.io/layout_moyo-header/)
- [TEST REPORT LINK](https://Nolofinve.github.io/layout_moyo-header/report/html_report/)
